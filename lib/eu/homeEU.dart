...
class HomeEU extends StatefulWidget {
  const HomeEU({Key? key}) : super(key: key);

  @override
  State<HomeEU> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<HomeEU> {
  int _counter = 0;
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          'แปลงจากเงินบาท(THB) เป็น ยูโร(EUR)',
                              ...
                              showDialog(
                                  ...
                                  builder: (BuildContext context) {
                                    return CupertinoAlertDialog(
                                      ...
                                      content: Text("เท่ากับ $total EUR",
