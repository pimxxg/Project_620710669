...
class HomeUSA extends StatefulWidget {
  const HomeUSA({Key? key}) : super(key: key);

  @override
  State<HomeUSA> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<HomeUSA> {
  int _counter = 0;
              ...
              Expanded(
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      'แปลงจากเงินบาท(THB) เป็น ดอลลาห์สหรัฐ(USD)',
                          ...
                          showDialog(
                              ...
                              builder: (BuildContext context) {
                                return CupertinoAlertDialog(
                                  ...
                                  content: Text("เท่ากับ $total USD",
