...
class HomeUK extends StatefulWidget {
  const HomeUK({Key? key}) : super(key: key);

  @override
  State<HomeUK> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<HomeUK> {
  int _counter = 0;
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          'แปลงจากเงินบาท(THB) เป็น ปอนด์สเตอร์ลิง(GBP)',
                              ...
                              showDialog(
                                  ...
                                  builder: (BuildContext context) {
                                    return CupertinoAlertDialog(
                                      ...
                                      content: Text("เท่ากับ $total GBP",
